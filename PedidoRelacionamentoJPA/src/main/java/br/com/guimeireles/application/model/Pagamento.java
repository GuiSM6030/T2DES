...
public class Pagamento implements Serializable {
	...
	//escolhas do nome da coluna e se não tiver nada ela vai automatico o nome do atributo
	@Column(name = "tipo_pagto", length = 20, nullable = false)
	private TipoPagamento tipoPagto;
	
	@OneToOne(mappedBy = "pagamento")// OneToOne cardinalidade do relacionamento (1,1)
